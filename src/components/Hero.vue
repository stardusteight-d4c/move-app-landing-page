...
<template>
  <section
    class="bg-hero-mobile sm:bg-hero-tablet lg:bg-hero-desktop relative bg-100% xl:bg-cover w-screen min-h-screen py-28 2xl:py-0 2xl:h-screen overflow-hidden"
  >
    <Navbar />
    <div
